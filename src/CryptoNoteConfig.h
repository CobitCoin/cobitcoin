...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 1976532;
...
const uint32_t POW_CRYPTONIGHT_V7_BLOCK_INDEX                 = 13500;
const uint32_t POW_CRYPTONIGHT_V7_LAST_BLOCK                 = 4294967294;
...
const int      P2P_DEFAULT_PORT                              =  18168;
const int      RPC_DEFAULT_PORT                              =  18169;
